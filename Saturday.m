...
%                             x1=x1+x2;
                            ...
                            B5=(4*NU-3)/2*(1/2*x1^2*log(x1^2)-3/2*x1^2);
...
%                            having problem
                           y2Const9=1/2;
                           limConst2=1/2*log(x1^2);
%                            having problem
                           limConst7=-1/2*log(x1^2);
                           limConst3=-1+1/2*log(x1^2);                           
                           limConst8=-1/2*log(x1^2)
...
%                             x2=x2+x1;
                            ...
                            yConst6=0;                            
                            yConst11=0;
                            B1=(4*NU-3)/2*(1/2*x2^2*log(x2^2)-3/2*x2^2);
                            B2=a^2*Treat2+b^2*y2Const2+2*a*b*yConst6;
                            B3=c^2*Treat2+a^2*y2Const2+2*a*c*yConst6;
                            B4=a*c*Treat2+(a^2+b*c)*yConst6+a*b*y2Const2;  
    ...
    %                     Ui
                           ...
                           y2Const9=1/2;
%                            having problem
                           limConst2=-1/2*log(x2^2);
                           limConst7=1/2*log(x2^2);
                           limConst3=-1/2*log(x2^2);                           
                           limConst8=1/2*log(x2^2);
...
%                         -----------------------------------------
                            ...
                            Treat2=x2*(x2-x1)-1/2*(x2^2-x1^2);
                            y2Const2=0;
                            yConst6=0;
                            Treat6=-x1*(x2-x1)+1/2*(x2^2-x1^2);
                            y2Const7=0;
                            yConst11=0;
    ...
    %                     Ui
                           ...
                           y3cst3=0;
                           y4cst3=0;
                           ycst4=pi/2*3/8*(sign(x2)-sign(x1));
                           y4h2=3/8*(1/x2-1/x1);
                           yConst5=-pi/4*(sign(x2)-sign(x1));
                           y2Const4=x2/2*(1/x2-1/x1);
                           limConst2=-1/2*log(x2^2/x1^2);
                           limConst3=(-x2*(1/x2-1/x1)-log(x2^2/x1^2))/2;
                           yConst10=pi/2*(sign(x2)-sign(x1))/2;
                           y2Const9=-x1/2*(1/x2-1/x1);
                           limConst8=(log(x2^2/x1^2)+x1*(1/x2-1/x1))/2;
                           limConst7=1/2*log(x2^2/x1^2);
                           ywer1=a*yConst5+b*y2Const4;
                           ywer2=a*yConst10+b*y2Const9;
                           ywer3=c*yConst5+a*y2Const4;
                           ywer4=c*yConst10+a*y2Const9;
                           ymj1=a^3*(x2*ycst1-ycst4)+3*a^2*b*(x2*y2cst2-y2cst1)+3*a*b^2*(x2*y3cst3-y3cst2)+b^3*(x2*y4h2-y4cst3);
                           ymj2=a^3*(ycst4-x1*ycst1)+3*a^2*b*(y2cst1-x1*y2cst2)+3*a*b^2*(y3cst2-x1*y3cst3)+b^3*(y4cst3-x1*y4h2);
                           ymj3=a^2*c*(x2*ycst1-ycst4)+(a^3+2*a*b*c)*(x2*y2cst2-y2cst1)+(b^2*c+2*a^2*b)*(x2*y3cst3-y3cst2)+b^2*a*(x2*y4h2-y4cst3);
                           ymj4=a^2*c*(ycst4-x1*ycst1)+(a^3+2*a*b*c)*(y2cst1-x1*y2cst2)+(b^2*c+2*a^2*b)*(y3cst2-x1*y3cst3)+b^2*a*(y4cst3-x1*y4h2);
                           ymj5=a*c^2*(x2*ycst1-ycst4)+(2*a^2*c+b*c^2)*(x2*y2cst2-y2cst1)+(a^3+2*a*b*c)*(x2*y3cst3-y3cst2)+a^2*b*(x2*y4h2-y4cst3);
                           ymj6=a*c^2*(ycst4-x1*ycst1)+(2*a^2*c+b*c^2)*(y2cst1-x1*y2cst2)+(a^3+2*a*b*c)*(y3cst2-x1*y3cst3)+a^2*b*(y4cst3-x1*y4h2);
                           ymj7=c^3*(x2*ycst1-ycst4)+3*c^2*a*(x2*y2cst2-y2cst1)+3*c*a^2*(x2*y3cst3-y3cst2)+a^3*(x2*y4h2-y4cst3);
                           ymj8=c^3*(ycst4-x1*ycst1)+3*c^2*a*(y2cst1-x1*y2cst2)+3*c*a^2*(y3cst2-x1*y3cst3)+a^3*(y4cst3-x1*y4h2);
                           yme1=ywer1-4*ymj1;
                           me2=a^2*limConst3+2*a*b*yConst5+b^2*y2Const4;
                           yme3=ywer2-4*ymj2;
                           me4=a^2*limConst8+2*a*b*yConst10+b^2*y2Const9;
                        ...
                        Const2=x2/y0*(atan(x2/y0)-atan(x1/y0))-(log(x2^2+y0^2)-log(x1^2+y0^2))/2;
                        ...
                        Const7=-x1/y0*(atan(x2/y0)-atan(x1/y0))+(log(x2^2+y0^2)-log(x1^2+y0^2))/2;
                        ...
                        A5=-(1-2*NU)*((a*n2-c*n1)*Const6+(b*n2-a*n1)*y0*Const2);
                        A6=(1-2*NU)*y0*Const7;
                        ...
                        A10=-(1-2*NU)*((a*n2-c*n1)*Const11+(b*n2-a*n1)*y0*Const7);
                        h11b=A1+A2;
                        h22b=A1+A3;
                        h12b=A4+A5;
                        h21b=A4-A5;
...
%                 ----------------
        ...
        if BLOG==1  
           iNterU=cat(1,iNterU,[iA InNode(iKP,:) UPknow(ZX,2:3)]);
           
           iNterP=cat(1,iNterP,[iA InNode(iKP,:) UPknow(ZX,6:7)]);
        end
end
